...
public class CommentController {
    ...
    public ResponseEntity<List<GetCommentResponse>> getCommentByTaskId(@PathVariable Long taskId)
    {
        log.info("Inside get comment by task id controller --------------------------->{}",taskId);
        ResponseEntity<List<GetCommentResponse>> response = commentService.getCommentByTaskId(taskId);
